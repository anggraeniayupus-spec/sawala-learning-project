...
Repositori ini berisi dokumentasi, modul latihan, dan *mini project* dari program pembelajaran **Full-Stack JavaScript & TypeScript** selama 10 minggu.
...
1. Pastikan sudah menginstal **Node.js** (versi 18+ direkomendasikan).
2. Clone repositori ini:
   ```bash
   git clone [https://github.com/username/sawala-learning-project.git](https://github.com/username/sawala-learning-project.git)
   cd sawala-learning-project
3. lalu jalankan file javascript dasar diterminal:
   ```bash
